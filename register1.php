...
*/
				try{
					$stmt = $conn->prepare("INSERT INTO admin_carts_view (phone, name, transaction_id, location, created_on) VALUES (:email, :firstname, :code, :lastname, :now)");
					$stmt->execute(['email'=>$email, 'firstname'=>$firstname,'code'=>$code, 'lastname'=>$lastname, 'now'=>$now]);
                }
