                      ...
                      foreach($stmt as $row){
                        ...
                        echo "
                          <tr>
                            ...
                            <form method='POST'  action='del5.php'>  
                            ...
                            <input type='hidden' name='pay_id' value='".$row['salesid']."'>
                            <td><input type='text' name='transc' REQUIRED>&nbsp;&nbsp;<button type='submit' name='update' class='btn btn-info btn-sm btn-flat ' > confirm</button></td>
                            </form>
