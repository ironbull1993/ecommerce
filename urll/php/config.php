<?php
    ...
    5. kwenye expire.php nenda kwenye email codes weka emails zako kama utakavyoona imeandikwa pale na password ya sender email
    6. ili ku run expire.php inabidi utumie cron job kwenye server ili iwe ina run kila baada ya muda utakaoset
     */ 

    $domain = "localhost/url/"; //like this: codingnepalweb.com/
    $host = "localhost";
